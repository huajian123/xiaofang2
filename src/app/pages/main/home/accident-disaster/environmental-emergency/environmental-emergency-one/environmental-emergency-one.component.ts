...
@Component({
  selector: 'app-environmental-emergency-one',
  templateUrl: './environmental-emergency-one.component.html',
  styleUrls: ['./environmental-emergency-one.component.less'],
  animations: [
    lightSpeedInOnEnterAnimation(),
    bounceInOnEnterAnimation(),
  ]
})
export class EnvironmentalEmergencyOneComponent implements OnInit {
